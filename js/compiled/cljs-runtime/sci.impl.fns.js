...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__59481,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__59482__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59482__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59482__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59482__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59482__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__59519 = cljs.core.next(args__$1);
var G__59520 = cljs.core.next(params__$1);
var G__59521 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__59519;
params__$1 = G__59520;
ret = G__59521;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__59484 = ctx__$1;
var G__59485 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__59484,G__59485) : interpret.call(null,G__59484,G__59485));
...
var vec__59486 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59486,(0),null);
var vec__59489 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59486,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59489,(0),null);
var G__59522 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__59522;
continue;
} else {
var G__59523 = recur_val;
args = G__59523;
continue;
}
} else {
...
var G__59524__i = 0, G__59524__a = new Array(arguments.length -  0);
while (G__59524__i < G__59524__a.length) {G__59524__a[G__59524__i] = arguments[G__59524__i + 0]; ++G__59524__i;}
  args = new cljs.core.IndexedSeq(G__59524__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__59525){
var args = cljs.core.seq(arglist__59525);
...
var map__59492 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59492__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59492__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__59496){
...
var f = map__59497__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59497__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59497__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__59526__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(self_ref),args);
};
var G__59526 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__59527__i = 0, G__59527__a = new Array(arguments.length -  0);
while (G__59527__i < G__59527__a.length) {G__59527__a[G__59527__i] = arguments[G__59527__i + 0]; ++G__59527__i;}
  args = new cljs.core.IndexedSeq(G__59527__a,0,null);
} 
return G__59526__delegate.call(this,args);};
G__59526.cljs$lang$maxFixedArity = 0;
G__59526.cljs$lang$applyTo = (function (arglist__59528){
var args = cljs.core.seq(arglist__59528);
return G__59526__delegate(args);
});
G__59526.cljs$core$IFn$_invoke$arity$variadic = G__59526__delegate;
return G__59526;
})()
;
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59494_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__59494_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__59529__delegate = function (args){
...
var G__59529 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__59530__i = 0, G__59530__a = new Array(arguments.length -  0);
while (G__59530__i < G__59530__a.length) {G__59530__a[G__59530__i] = arguments[G__59530__i + 0]; ++G__59530__i;}
  args = new cljs.core.IndexedSeq(G__59530__a,0,null);
} 
return G__59529__delegate.call(this,args);};
G__59529.cljs$lang$maxFixedArity = 0;
G__59529.cljs$lang$applyTo = (function (arglist__59534){
var args = cljs.core.seq(arglist__59534);
return G__59529__delegate(args);
});
G__59529.cljs$core$IFn$_invoke$arity$variadic = G__59529__delegate;
return G__59529;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__59495_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__59495_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
