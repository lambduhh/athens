...
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40481__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40481__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__40483 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__40483__$1 = (((G__40483 == null))?null:cljs.core.persistent_BANG_(G__40483));
if((G__40483__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__40483__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__40484){
var vec__40485 = p__40484;
var seq__40486 = cljs.core.seq(vec__40485);
var first__40487 = cljs.core.first(seq__40486);
var seq__40486__$1 = cljs.core.next(seq__40486);
var frame = first__40487;
var frames = seq__40486__$1;
...
var results = (function (){var G__40488 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__40488,kvps);
} else {
return G__40488;
}
})();
...
var map__40489 = parent;
var map__40489__$1 = (((((!((map__40489 == null))))?(((((map__40489.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40489.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__40489):map__40489);
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40489__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40489__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_40548 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_40548,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__40492){
var vec__40493 = p__40492;
var seq__40494 = cljs.core.seq(vec__40493);
var first__40495 = cljs.core.first(seq__40494);
var seq__40494__$1 = cljs.core.next(seq__40494);
var parent = first__40495;
var frames = seq__40494__$1;
...
var found = cljs.core.not_empty((function (){var G__40496 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__40496);
} else {
return G__40496;
}
})());
...
var as_value = (function (){var G__40497 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__40491_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__40491_SHARP_]);
}),G__40497);
} else {
return G__40497;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__40498 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__40498);
} else {
return G__40498;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__40499 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__40499,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__40499;
}
})());
...
var vec__40500 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40500,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40500,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__40503){
var vec__40504 = p__40503;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40504,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40504,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__40507){
var vec__40508 = p__40507;
var seq__40509 = cljs.core.seq(vec__40508);
var first__40510 = cljs.core.first(seq__40509);
var seq__40509__$1 = cljs.core.next(seq__40509);
var frame = first__40510;
var frames = seq__40509__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__40511){
var vec__40512 = p__40511;
var seq__40513 = cljs.core.seq(vec__40512);
var first__40514 = cljs.core.first(seq__40513);
var seq__40513__$1 = cljs.core.next(seq__40513);
var frame = first__40514;
var frames = seq__40513__$1;
...
var vec__40515 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40515,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40515,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40522__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40522__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__40524 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__40524,attr,eid);
} else {
return G__40524;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40525__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40525__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__40527){
while(true){
...
var frame = first__40530;
var frames = seq__40529__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__40593 = db;
var G__40594 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__40593;
p__40527 = G__40594;
continue;
}
...
while(true){
var G__40531 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__40531__$1 = (((G__40531 instanceof cljs.core.Keyword))?G__40531.fqn:null);
switch (G__40531__$1) {
case "expand":
var G__40596 = db;
var G__40597 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__40596;
frames = G__40597;
continue;
...
case "expand-rev":
var G__40598 = db;
var G__40599 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__40598;
frames = G__40599;
continue;
...
case "pattern":
var G__40600 = db;
var G__40601 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__40600;
frames = G__40601;
continue;
...
case "recursion":
var G__40602 = db;
var G__40603 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__40602;
frames = G__40603;
continue;
...
var f = first__40534;
var remaining = seq__40533__$1;
var result = (function (){var G__40535 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__40535);
} else {
return G__40535;
}
})();
...
var G__40604 = db;
var G__40605 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__40536 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__40536,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__40536;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__40531__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__40537_SHARP_){
return datascript.db.entid_strict(db,p1__40537_SHARP_);
})),eids);
