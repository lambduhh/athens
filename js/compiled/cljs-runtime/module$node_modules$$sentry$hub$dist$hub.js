...
function(){return this.getStackTop().scope};Hub.prototype.getStack=function(){return this._stack};Hub.prototype.getStackTop=function(){return this._stack[this._stack.length-1]};Hub.prototype.captureException=function(exception,hint){var eventId=this._lastEventId=utils_1.uuid4(),finalHint=hint;if(!hint){try{throw Error("Sentry syntheticException");}catch(exception$17){hint=exception$17}finalHint={originalException:exception,syntheticException:hint}}this._invokeClient("captureException",exception,tslib_1.__assign(tslib_1.__assign({},
