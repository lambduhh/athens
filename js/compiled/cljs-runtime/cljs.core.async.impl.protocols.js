...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_45799 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_45799(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_45800 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_45800(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_45801 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_45801(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_45802 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_45802(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_45803 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_45803(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_45804 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_45804(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_45805 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_45805(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_45806 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_45806(b);
}
});
