...
var G__25266__delegate = function (x,y,more){
...
while (G__25267__i < G__25267__a.length) {G__25267__a[G__25267__i] = arguments[G__25267__i + 2]; ++G__25267__i;}
  more = new cljs.core.IndexedSeq(G__25267__a,0,null);
} 
...
var y = cljs.core.first(arglist__25269);
var more = cljs.core.rest(arglist__25269);
...
var G__25271 = null;
if (arguments.length > 2) {
var G__25273__i = 0, G__25273__a = new Array(arguments.length -  2);
while (G__25273__i < G__25273__a.length) {G__25273__a[G__25273__i] = arguments[G__25273__i + 2]; ++G__25273__i;}
G__25271 = new cljs.core.IndexedSeq(G__25273__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__25271);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25147__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__25148 = u(y);
var map__25148__$1 = (((((!((map__25148 == null))))?(((((map__25148.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25148.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__25148):map__25148);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25148__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
...
G__25283 = new cljs.core.IndexedSeq(G__25284__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__25283);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
while (G__25293__i < G__25293__a.length) {G__25293__a[G__25293__i] = arguments[G__25293__i + 2]; ++G__25293__i;}
  more = new cljs.core.IndexedSeq(G__25293__a,0,null);
} 
...
return day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__25296);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
