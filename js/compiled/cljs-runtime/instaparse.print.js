...
if(cljs.core.truth_(((cljs.core.not(hidden_QMARK_))?(function (){var G__43509 = (parser.cljs$core$IFn$_invoke$arity$1 ? parser.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"tag","tag",-1290361223)) : parser.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223)));
return (tag_set.cljs$core$IFn$_invoke$arity$1 ? tag_set.cljs$core$IFn$_invoke$arity$1(G__43509) : tag_set.call(null,G__43509));
})():false))){
...
instaparse.print.char_range__GT_str = (function instaparse$print$char_range__GT_str(p__43511){
var map__43512 = p__43511;
var map__43512__$1 = (((((!((map__43512 == null))))?(((((map__43512.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__43512.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__43512):map__43512);
var lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43512__$1,new cljs.core.Keyword(null,"lo","lo",-931799889));
var hi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43512__$1,new cljs.core.Keyword(null,"hi","hi",-1821422114));
...
(instaparse.print.combinators__GT_str.cljs$core$IFn$_invoke$arity$2 = (function (p__43517,hidden_QMARK_){
...
var p = map__43518__$1;
var parser = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43518__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310));
var parser1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43518__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422));
var parser2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43518__$1,new cljs.core.Keyword(null,"parser2","parser2",1013754688));
var parsers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43518__$1,new cljs.core.Keyword(null,"parsers","parsers",-804353827));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43518__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var _STAR_print_newline_STAR__orig_val__43525_43553 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__43526_43554 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__43527_43555 = true;
var _STAR_print_fn_STAR__temp_val__43528_43556 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__43527_43555);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__43528_43556);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__43526_43554);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__43525_43553);
}
...
case "string-ci":
var sb__4667__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__43532_43557 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__43533_43558 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__43534_43559 = true;
var _STAR_print_fn_STAR__temp_val__43535_43560 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__43534_43559);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__43535_43560);

try{cljs.core.pr.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string","string",-1989541586).cljs$core$IFn$_invoke$arity$1(p)], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__43533_43558);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__43532_43557);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__43522__$1)].join('')));
 ...
 */
instaparse.print.Parser__GT_str = (function instaparse$print$Parser__GT_str(p__43536){
...
var grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43537__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43537__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.cons(instaparse.print.rule__GT_str(start,(grammar.cljs$core$IFn$_invoke$arity$1 ? grammar.cljs$core$IFn$_invoke$arity$1(start) : grammar.call(null,start))),(function (){var iter__4529__auto__ = (function instaparse$print$Parser__GT_str_$_iter__43539(s__43540){
return (new cljs.core.LazySeq(null,(function (){
var s__43540__$1 = s__43540;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__43540__$1);
if(temp__5735__auto__){
var s__43540__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__43540__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__43540__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__43542 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__43541 = (0);
while(true){
if((i__43541 < size__4528__auto__)){
var vec__43543 = cljs.core._nth(c__4527__auto__,i__43541);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43543,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43543,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
cljs.core.chunk_append(b__43542,instaparse.print.rule__GT_str(non_terminal,parser));

var G__43561 = (i__43541 + (1));
i__43541 = G__43561;
continue;
} else {
var G__43562 = (i__43541 + (1));
i__43541 = G__43562;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__43542),instaparse$print$Parser__GT_str_$_iter__43539(cljs.core.chunk_rest(s__43540__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__43542),null);
}
} else {
var vec__43546 = cljs.core.first(s__43540__$2);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43546,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43546,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
return cljs.core.cons(instaparse.print.rule__GT_str(non_terminal,parser),instaparse$print$Parser__GT_str_$_iter__43539(cljs.core.rest(s__43540__$2)));
} else {
var G__43563 = cljs.core.rest(s__43540__$2);
s__43540__$1 = G__43563;
continue;
}
}
} else {
