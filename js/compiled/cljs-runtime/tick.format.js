...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__34504 = goog.object.get(JSJodaLocale,"Locale");
if((G__34504 == null)){
return null;
} else {
return goog.object.get(G__34504,"US");
}
}catch (e34503){if((e34503 instanceof Error)){
var e = e34503;
return null;
} else {
throw e34503;
