...
var G__44619 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__44619)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__44619)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__44619)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__44619)].join('')));
...
var G__44668 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__44669 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__44668;
v = G__44669;
continue;
} else {
var G__44670 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__44671 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__44670;
v = G__44671;
continue;
}
...
break;
case "\"":
var G__44672 = cljs.core.next(sq);
var G__44673 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__44672;
v = G__44673;
continue;
...
break;
default:
var G__44674 = cljs.core.next(sq);
var G__44675 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__44674;
v = G__44675;
continue;
...
while(true){
var G__44633 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__44633__$1 = (((G__44633 instanceof cljs.core.Keyword))?G__44633.fqn:null);
switch (G__44633__$1) {
case "rule":
var vec__44634 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44634,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44634,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__44637 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__44637) : instaparse.cfg.content.call(null,G__44637));
...
break;
case "paren":
var G__44678 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__44678;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__44638 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__44638) : instaparse.cfg.build_rule.call(null,G__44638));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__44640 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__44640) : instaparse.cfg.build_rule.call(null,G__44640));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__44641 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__44641) : instaparse.cfg.build_rule.call(null,G__44641));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__44642 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__44642) : instaparse.cfg.build_rule.call(null,G__44642));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__44643 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__44643) : instaparse.cfg.build_rule.call(null,G__44643));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__44644 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__44644) : instaparse.cfg.build_rule.call(null,G__44644));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__44633__$1)].join('')));
...
while(true){
var G__44645 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
var G__44645__$1 = (((G__44645 instanceof cljs.core.Keyword))?G__44645.fqn:null);
switch (G__44645__$1) {
case "nt":
...
case "neg":
case "rep":
var G__44680 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__44680;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__44645__$1)].join('')));
...
var valid_nts_44681 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__44646_44682 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__44647_44683 = null;
var count__44648_44684 = (0);
var i__44649_44685 = (0);
while(true){
if((i__44649_44685 < count__44648_44684)){
var nt_44686 = chunk__44647_44683.cljs$core$IIndexed$_nth$arity$2(null,i__44649_44685);
if(cljs.core.truth_((valid_nts_44681.cljs$core$IFn$_invoke$arity$1 ? valid_nts_44681.cljs$core$IFn$_invoke$arity$1(nt_44686) : valid_nts_44681.call(null,nt_44686)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_44686),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__44687 = seq__44646_44682;
var G__44688 = chunk__44647_44683;
var G__44689 = count__44648_44684;
var G__44690 = (i__44649_44685 + (1));
seq__44646_44682 = G__44687;
chunk__44647_44683 = G__44688;
count__44648_44684 = G__44689;
i__44649_44685 = G__44690;
continue;
} else {
var temp__5735__auto___44691 = cljs.core.seq(seq__44646_44682);
if(temp__5735__auto___44691){
var seq__44646_44692__$1 = temp__5735__auto___44691;
if(cljs.core.chunked_seq_QMARK_(seq__44646_44692__$1)){
var c__4556__auto___44693 = cljs.core.chunk_first(seq__44646_44692__$1);
var G__44694 = cljs.core.chunk_rest(seq__44646_44692__$1);
var G__44695 = c__4556__auto___44693;
var G__44696 = cljs.core.count(c__4556__auto___44693);
var G__44697 = (0);
seq__44646_44682 = G__44694;
chunk__44647_44683 = G__44695;
count__44648_44684 = G__44696;
i__44649_44685 = G__44697;
continue;
} else {
var nt_44698 = cljs.core.first(seq__44646_44692__$1);
if(cljs.core.truth_((valid_nts_44681.cljs$core$IFn$_invoke$arity$1 ? valid_nts_44681.cljs$core$IFn$_invoke$arity$1(nt_44698) : valid_nts_44681.call(null,nt_44698)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_44698),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__44699 = cljs.core.next(seq__44646_44692__$1);
var G__44700 = null;
var G__44701 = (0);
var G__44702 = (0);
seq__44646_44682 = G__44699;
chunk__44647_44683 = G__44700;
count__44648_44684 = G__44701;
i__44649_44685 = G__44702;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__44650_44703 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__44651_44704 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__44652_44705 = true;
var _STAR_print_fn_STAR__temp_val__44653_44706 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__44652_44705);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__44653_44706);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__44651_44704);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__44650_44703);
}
...
var len__4736__auto___44707 = arguments.length;
var i__4737__auto___44708 = (0);
while(true){
if((i__4737__auto___44708 < len__4736__auto___44707)){
args__4742__auto__.push((arguments[i__4737__auto___44708]));

var G__44713 = (i__4737__auto___44708 + (1));
i__4737__auto___44708 = G__44713;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__44656){
...
var opts = map__44657__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__44659 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__44660 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__44660);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4667__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__44661_44731 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__44662_44732 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__44663_44733 = true;
var _STAR_print_fn_STAR__temp_val__44664_44734 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__44663_44733);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__44664_44734);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__44662_44732);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__44661_44731);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__44659);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq44654){
var G__44655 = cljs.core.first(seq44654);
var seq44654__$1 = cljs.core.next(seq44654);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44655,seq44654__$1);
}));
