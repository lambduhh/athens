...
var G__40538 = db;
var G__40539 = e;
var G__40540 = cljs.core.volatile_BANG_(false);
var G__40541 = cljs.core.volatile_BANG_(cljs.core.PersistentArrayMap.EMPTY);
return (datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4 ? datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4(G__40538,G__40539,G__40540,G__40541) : datascript.impl.entity.__GT_Entity.call(null,G__40538,G__40539,G__40540,G__40541));
} else {
return null;
}
});
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__40542_SHARP_,p2__40543_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__40542_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__40543_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
} else {
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__40544_SHARP_,p2__40545_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__40544_SHARP_,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__40545_SHARP_));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
if(datascript.db.ref_QMARK_(db,a)){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__40546_SHARP_,p2__40547_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__40546_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"e","e",1381269198).cljs$core$IFn$_invoke$arity$1(p2__40547_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
return not_found;
...
var iter__4529__auto__ = (function datascript$impl$entity$js_seq_$_iter__40549(s__40550){
...
var c__4527__auto__ = cljs.core.chunk_first(s__40550__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__40552 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__40551 = (0);
while(true){
if((i__40551 < size__4528__auto__)){
var vec__40553 = cljs.core._nth(c__4527__auto__,i__40551);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40553,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40553,(1),null);
cljs.core.chunk_append(b__40552,((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)));

var G__40612 = (i__40551 + (1));
i__40551 = G__40612;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__40552),datascript$impl$entity$js_seq_$_iter__40549(cljs.core.chunk_rest(s__40550__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__40552),null);
}
} else {
var vec__40556 = cljs.core.first(s__40550__$2);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40556,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40556,(1),null);
return cljs.core.cons(((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)),datascript$impl$entity$js_seq_$_iter__40549(cljs.core.rest(s__40550__$2)));
}
} else {
return null;
}
...
var G__40618 = null;
var G__40618__1 = (function (f){
var self__ = this;
var this$ = this;
var seq__40560 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__40561 = null;
var count__40562 = (0);
var i__40563 = (0);
while(true){
if((i__40563 < count__40562)){
var vec__40570 = chunk__40561.cljs$core$IIndexed$_nth$arity$2(null,i__40563);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40570,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40570,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__40620 = seq__40560;
var G__40621 = chunk__40561;
var G__40622 = count__40562;
var G__40623 = (i__40563 + (1));
seq__40560 = G__40620;
chunk__40561 = G__40621;
count__40562 = G__40622;
i__40563 = G__40623;
continue;
} else {
...
var c__4556__auto__ = cljs.core.chunk_first(seq__40560__$1);
var G__40624 = cljs.core.chunk_rest(seq__40560__$1);
var G__40625 = c__4556__auto__;
var G__40626 = cljs.core.count(c__4556__auto__);
var G__40627 = (0);
seq__40560 = G__40624;
chunk__40561 = G__40625;
count__40562 = G__40626;
i__40563 = G__40627;
continue;
} else {
var vec__40573 = cljs.core.first(seq__40560__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40573,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40573,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__40632 = cljs.core.next(seq__40560__$1);
var G__40633 = null;
var G__40634 = (0);
var G__40635 = (0);
seq__40560 = G__40632;
...
var G__40618__2 = (function (f,use_as_this){
var self__ = this;
var this$ = this;
var seq__40576 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__40577 = null;
var count__40578 = (0);
var i__40579 = (0);
while(true){
if((i__40579 < count__40578)){
var vec__40586 = chunk__40577.cljs$core$IIndexed$_nth$arity$2(null,i__40579);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40586,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40586,(1),null);
f.call(use_as_this,v,a,this$);


var G__40645 = seq__40576;
var G__40646 = chunk__40577;
var G__40647 = count__40578;
var G__40648 = (i__40579 + (1));
seq__40576 = G__40645;
chunk__40577 = G__40646;
count__40578 = G__40647;
i__40579 = G__40648;
continue;
} else {
...
var c__4556__auto__ = cljs.core.chunk_first(seq__40576__$1);
var G__40664 = cljs.core.chunk_rest(seq__40576__$1);
var G__40665 = c__4556__auto__;
var G__40666 = cljs.core.count(c__4556__auto__);
var G__40667 = (0);
seq__40576 = G__40664;
chunk__40577 = G__40665;
count__40578 = G__40666;
i__40579 = G__40667;
continue;
} else {
var vec__40589 = cljs.core.first(seq__40576__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40589,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40589,(1),null);
f.call(use_as_this,v,a,this$);


var G__40677 = cljs.core.next(seq__40576__$1);
var G__40678 = null;
var G__40679 = (0);
var G__40680 = (0);
seq__40576 = G__40677;
chunk__40577 = G__40678;
count__40578 = G__40679;
i__40579 = G__40680;
continue;
}
} else {
...
G__40618 = function(f,use_as_this){
switch(arguments.length){
case 1:
return G__40618__1.call(this,f);
case 2:
return G__40618__2.call(this,f,use_as_this);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__40618.cljs$core$IFn$_invoke$arity$1 = G__40618__1;
G__40618.cljs$core$IFn$_invoke$arity$2 = G__40618__2;
return G__40618;
})()
);
...
var G__40592 = (datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2 ? datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2(this$,attr) : datascript.impl.entity.lookup_entity.call(null,this$,attr));
if(datascript.db.multival_QMARK_(self__.db,attr)){
return datascript.impl.entity.multival__GT_js(G__40592);
} else {
return G__40592;
}
}
...
var self__ = this;
var self__ = this;
var G__40606 = (arguments.length - (1));
switch (G__40606) {
case (1):
...
(datascript.impl.entity.Entity.prototype.apply = (function (self__,args40559){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args40559)));
}));
...
var temp__5737__auto__ = (function (){var fexpr__40609 = cljs.core.deref(this$.cache);
return (fexpr__40609.cljs$core$IFn$_invoke$arity$1 ? fexpr__40609.cljs$core$IFn$_invoke$arity$1(attr) : fexpr__40609.call(null,attr));
})();
...
var temp__5735__auto___40757 = cljs.core.not_empty(datascript.db._search(e.db,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [e.eid], null)));
if(cljs.core.truth_(temp__5735__auto___40757)){
var datoms_40758 = temp__5735__auto___40757;
cljs.core.vreset_BANG_(e.cache,datascript.impl.entity.touch_components(e.db,datascript.impl.entity.datoms__GT_cache(e.db,datoms_40758)));
