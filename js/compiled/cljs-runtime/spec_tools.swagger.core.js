...
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.swagger.core","default","spec-tools.swagger.core/default",1361779456)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__56290 = cljs.core.get_global_hierarchy;
return (fexpr__56290.cljs$core$IFn$_invoke$arity$0 ? fexpr__56290.cljs$core$IFn$_invoke$arity$0() : fexpr__56290.call(null));
})());
...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__56291){
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56292__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56292__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var vec__56294 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56294,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56294,(1),null);
...
var method_cache__4621__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4622__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__56299 = cljs.core.get_global_hierarchy;
...
var map__56300 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
...
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56300__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56300__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__56302){
...
var schema = map__56306__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56306__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var method_cache__4621__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4622__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__56308 = cljs.core.get_global_hierarchy;
...
})(),(function (){var iter__4529__auto__ = (function spec_tools$swagger$core$iter__56309(s__56310){
return (new cljs.core.LazySeq(null,(function (){
var s__56310__$1 = s__56310;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__56310__$1);
if(temp__5735__auto__){
var s__56310__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__56310__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__56310__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__56312 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__56311 = (0);
while(true){
if((i__56311 < size__4528__auto__)){
var vec__56313 = cljs.core._nth(c__4527__auto__,i__56311);
...
cljs.core.chunk_append(b__56312,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56312),spec_tools$swagger$core$iter__56309(cljs.core.chunk_rest(s__56310__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56312),null);
}
} else {
var vec__56317 = cljs.core.first(s__56310__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56317,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56317,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__56309(cljs.core.rest(s__56310__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__56320){
var vec__56321 = p__56320;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56321,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56321,(1),null);
return spec_tools.swagger.core.extract_parameter.cljs$core$IFn$_invoke$arity$2(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__56324,p){
var vec__56325 = p__56324;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56325,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56325,(1),null);
var acc__$1 = vec__56325;
