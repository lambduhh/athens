...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__58149){
var vec__58150 = p__58149;
var color_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58150,(0),null);
var color_v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58150,(1),null);
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(["--",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(color_k))].join('')),color_v], null),cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__58153){
var vec__58154 = p__58153;
var opacity_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58154,(0),null);
var opacity_v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58154,(1),null);
...
var permute_light_58167 = athens.style.permute_color_opacities(athens.style.THEME_LIGHT);
var permute_dark_58168 = athens.style.permute_color_opacities(athens.style.THEME_DARK);
stylefy.core.tag(":root",cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([permute_light_58167,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("stylefy.core","media","stylefy.core/media",-1323617834),cljs.core.PersistentArrayMap.createAsIfByAssoc([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"prefers-color-scheme","prefers-color-scheme",-1885369990),"dark"], null),permute_dark_58168])], null)], 0)));
