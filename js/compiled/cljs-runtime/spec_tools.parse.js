...
var fexpr__55108 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__55108.cljs$core$IFn$_invoke$arity$1 ? fexpr__55108.cljs$core$IFn$_invoke$arity$1(type) : fexpr__55108.call(null,type));
});
...
var G__55136 = cljs.spec.alpha.form(cljs.spec.alpha.get_spec(x));
x = G__55136;
continue;
} else {
if((x instanceof cljs.core.Symbol)){
var G__55109 = spec_tools.impl.normalize_symbol(x);
var G__55110 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__55109,G__55110) : spec_tools.parse.parse_form.call(null,G__55109,G__55110));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__55111 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__55112 = x;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__55111,G__55112) : spec_tools.parse.parse_form.call(null,G__55111,G__55112));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__55137 = cljs.spec.alpha.form(x);
x = G__55137;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__55113 = spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x);
var G__55114 = null;
...
var G__55115 = parse_data;
var G__55115__$1 = (((G__55115 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__55115));
var G__55115__$2 = (((G__55115__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__55115__$1));
var G__55115__$3 = (((G__55115__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__55115__$2));
var G__55115__$4 = (((G__55115__$3 == null))?null:cljs.core.seq(G__55115__$3));
if((G__55115__$4 == null)){
return null;
} else {
return cljs.core.set(G__55115__$4);
}
}
});
...
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__55116 = cljs.core.get_global_hierarchy;
return (fexpr__55116.cljs$core$IFn$_invoke$arity$0 ? fexpr__55116.cljs$core$IFn$_invoke$arity$0() : fexpr__55116.call(null));
})());
...
var map__55121 = spec_tools.impl.parse_keys(form);
var map__55121__$1 = (((((!((map__55121 == null))))?(((((map__55121.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55121.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__55121):map__55121);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55121__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55121__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55121__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55121__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55121__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__55123 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__55123__$1 = (cljs.core.truth_((function (){var or__4126__auto__ = req;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55123,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__55123);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55123__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__55123__$1;
}
}));
...
var map__55124 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55124__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__55126 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55126__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__55128){
var vec__55129 = p__55128;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55129,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55129,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55129,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__55132){
var vec__55133 = p__55132;
var seq__55134 = cljs.core.seq(vec__55133);
var first__55135 = cljs.core.first(seq__55134);
var seq__55134__$1 = cljs.core.next(seq__55134);
var ___$1 = first__55135;
var values = seq__55134__$1;
