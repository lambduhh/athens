...
stylefy.impl.styles.create_style_BANG_ = (function stylefy$impl$styles$create_style_BANG_(p__52324,style_created_handler){
...
var style = map__52326__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52326__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52326__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__52335_52366 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__52335_52366) : style_created_handler.call(null,G__52335_52366));

var seq__52336 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(props)));
var chunk__52337 = null;
var count__52338 = (0);
var i__52339 = (0);
while(true){
if((i__52339 < count__52338)){
var sub_style = chunk__52337.cljs$core$IIndexed$_nth$arity$2(null,i__52339);
var G__52348_52367 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__52349_52368 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__52348_52367,G__52349_52368) : stylefy.impl.styles.create_style_BANG_.call(null,G__52348_52367,G__52349_52368));


var G__52369 = seq__52336;
var G__52370 = chunk__52337;
var G__52371 = count__52338;
var G__52372 = (i__52339 + (1));
seq__52336 = G__52369;
chunk__52337 = G__52370;
count__52338 = G__52371;
i__52339 = G__52372;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__52336);
if(temp__5735__auto__){
var seq__52336__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__52336__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__52336__$1);
var G__52373 = cljs.core.chunk_rest(seq__52336__$1);
var G__52374 = c__4556__auto__;
var G__52375 = cljs.core.count(c__4556__auto__);
var G__52376 = (0);
seq__52336 = G__52373;
chunk__52337 = G__52374;
count__52338 = G__52375;
i__52339 = G__52376;
continue;
} else {
var sub_style = cljs.core.first(seq__52336__$1);
var G__52350_52377 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__52351_52378 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__52350_52377,G__52351_52378) : stylefy.impl.styles.create_style_BANG_.call(null,G__52350_52377,G__52351_52378));


var G__52379 = cljs.core.next(seq__52336__$1);
var G__52380 = null;
var G__52381 = (0);
var G__52382 = (0);
seq__52336 = G__52379;
chunk__52337 = G__52380;
count__52338 = G__52381;
i__52339 = G__52382;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__52352_SHARP_){
return ((typeof p1__52352_SHARP_ === 'string') || ((p1__52352_SHARP_ instanceof cljs.core.Keyword)) || ((p1__52352_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__52352#] (or (string? p1__52352#) (keyword? p1__52352#) (nil? p1__52352#))) class)))"].join('')));
}
});
/**
...
var len__4736__auto___52385 = arguments.length;
var i__4737__auto___52386 = (0);
while(true){
if((i__4737__auto___52386 < len__4736__auto___52385)){
args__4742__auto__.push((arguments[i__4737__auto___52386]));

var G__52387 = (i__4737__auto___52386 + (1));
i__4737__auto___52386 = G__52387;
continue;
} else {
}
break;
...
var resolved_sub_style = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__52353_SHARP_,p2__52354_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__52353_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432),p2__52354_SHARP_], null));
}),style,sub_styles);
if(cljs.core.truth_(resolved_sub_style)){
...
/** @this {Function} */
(stylefy.impl.styles.sub_style.cljs$lang$applyTo = (function (seq52355){
...
(stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2 = (function (styles,p__52359){
var map__52360 = p__52359;
var map__52360__$1 = (((((!((map__52360 == null))))?(((((map__52360.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52360.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__52360):map__52360);
var options = map__52360__$1;
var request_dom_update_after_done_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52360__$1,new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510));
var styles_52391__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__52362_52392 = cljs.core.seq(styles_52391__$1);
var chunk__52363_52393 = null;
var count__52364_52394 = (0);
var i__52365_52395 = (0);
while(true){
if((i__52365_52395 < count__52364_52394)){
var style_52396 = chunk__52363_52393.cljs$core$IIndexed$_nth$arity$2(null,i__52365_52395);
stylefy.impl.styles.use_style_BANG_(style_52396,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___52397 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_52396));
if(cljs.core.truth_(temp__5735__auto___52397)){
var sub_styles_52398 = temp__5735__auto___52397;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_52398,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__52401 = seq__52362_52392;
var G__52402 = chunk__52363_52393;
var G__52403 = count__52364_52394;
var G__52404 = (i__52365_52395 + (1));
seq__52362_52392 = G__52401;
chunk__52363_52393 = G__52402;
count__52364_52394 = G__52403;
i__52365_52395 = G__52404;
continue;
} else {
var temp__5735__auto___52405 = cljs.core.seq(seq__52362_52392);
if(temp__5735__auto___52405){
var seq__52362_52406__$1 = temp__5735__auto___52405;
if(cljs.core.chunked_seq_QMARK_(seq__52362_52406__$1)){
var c__4556__auto___52407 = cljs.core.chunk_first(seq__52362_52406__$1);
var G__52408 = cljs.core.chunk_rest(seq__52362_52406__$1);
var G__52409 = c__4556__auto___52407;
var G__52410 = cljs.core.count(c__4556__auto___52407);
var G__52411 = (0);
seq__52362_52392 = G__52408;
chunk__52363_52393 = G__52409;
count__52364_52394 = G__52410;
i__52365_52395 = G__52411;
continue;
} else {
var style_52412 = cljs.core.first(seq__52362_52406__$1);
stylefy.impl.styles.use_style_BANG_(style_52412,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___52413__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_52412));
if(cljs.core.truth_(temp__5735__auto___52413__$1)){
var sub_styles_52414 = temp__5735__auto___52413__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_52414,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__52415 = cljs.core.next(seq__52362_52406__$1);
var G__52416 = null;
var G__52417 = (0);
var G__52418 = (0);
seq__52362_52392 = G__52415;
chunk__52363_52393 = G__52416;
count__52364_52394 = G__52417;
i__52365_52395 = G__52418;
continue;
}
} else {
}
