...
if(cljs.core.truth_((function (){var fexpr__45179 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__45179.cljs$core$IFn$_invoke$arity$1 ? fexpr__45179.cljs$core$IFn$_invoke$arity$1(type) : fexpr__45179.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__45180 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__45180.cljs$core$IFn$_invoke$arity$1 ? fexpr__45180.cljs$core$IFn$_invoke$arity$1(type) : fexpr__45180.call(null,type));
})())){
} else {
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__45188)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__45188)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__45188)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__45188)].join('')));
...
var len__4736__auto___45259 = arguments.length;
var i__4737__auto___45260 = (0);
while(true){
if((i__4737__auto___45260 < len__4736__auto___45259)){
args__4742__auto__.push((arguments[i__4737__auto___45260]));

var G__45261 = (i__4737__auto___45260 + (1));
i__4737__auto___45260 = G__45261;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__45202){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__45210 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__45210) : instaparse.reduction.node_builders.call(null,G__45210));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq45198){
var G__45199 = cljs.core.first(seq45198);
var seq45198__$1 = cljs.core.next(seq45198);
var G__45200 = cljs.core.first(seq45198__$1);
var seq45198__$2 = cljs.core.next(seq45198__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45199,G__45200,seq45198__$2);
}));
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__45225){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__45228 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__45228) : instaparse.reduction.node_builders.call(null,G__45228));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq45218){
var G__45219 = cljs.core.first(seq45218);
var seq45218__$1 = cljs.core.next(seq45218);
var G__45220 = cljs.core.first(seq45218__$1);
var seq45218__$2 = cljs.core.next(seq45218__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45219,G__45220,seq45218__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k45234,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k45234,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__45240){
var vec__45241 = p__45240;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45241,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45241,(1),null);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this45235,other45236){
var self__ = this;
var this45235__$1 = this;
return (((!((other45236 == null)))) && ((this45235__$1.constructor === other45236.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45235__$1.grammar,other45236.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45235__$1.start_production,other45236.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45235__$1.output_format,other45236.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45235__$1.__extmap,other45236.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__45233){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__45244 = cljs.core.keyword_identical_QMARK_;
var expr__45245 = k__4388__auto__;
if(cljs.core.truth_((pred__45244.cljs$core$IFn$_invoke$arity$2 ? pred__45244.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__45245) : pred__45244.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__45245)))){
return (new instaparse.core.Parser(G__45233,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__45244.cljs$core$IFn$_invoke$arity$2 ? pred__45244.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__45245) : pred__45244.call(null,new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__45245)))){
return (new instaparse.core.Parser(self__.grammar,G__45233,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__45244.cljs$core$IFn$_invoke$arity$2 ? pred__45244.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__45245) : pred__45244.call(null,new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__45245)))){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__45233,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__45233),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__45233){
var self__ = this;
var this__4379__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__45233,self__.__extmap,self__.__hash));
}));
...
(instaparse.core.Parser.prototype.apply = (function (self__,args45238){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args45238)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__45237){
var extmap__4419__auto__ = (function (){var G__45248 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__45237,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__45237)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__45248);
} else {
return G__45248;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__45237),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__45237),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__45237),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var G__45357 = (i__4737__auto___45353 + (1));
i__4737__auto___45353 = G__45357;
continue;
} else {
}
break;
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__45251){
...
var _STAR_case_insensitive_literals_STAR__orig_val__45254 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__45255 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__45255);

try{var G__45256 = input_format;
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__45254);
}});
...
var map__45257 = temp__5733__auto__;
...
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45257__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45257__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq45249){
var G__45250 = cljs.core.first(seq45249);
var seq45249__$1 = cljs.core.next(seq45249);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45250,seq45249__$1);
}));
