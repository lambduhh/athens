...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54022_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__54022_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54021_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__54021_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54023_SHARP_){
return (((p1__54023_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__54023_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__54031,mapping){
...
var state = map__54032__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54032__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54032__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54032__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54028_SHARP_){
if((p1__54028_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__54028_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__54149 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__54150 = clojure.zip.next(loc);
loc = G__54150;
continue;
}
}
...
var len__4736__auto___54178 = arguments.length;
var i__4737__auto___54179 = (0);
while(true){
if((i__4737__auto___54179 < len__4736__auto___54178)){
args__4742__auto__.push((arguments[i__4737__auto___54179]));

var G__54180 = (i__4737__auto___54179 + (1));
i__4737__auto___54179 = G__54180;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__54056){
var vec__54057 = p__54056;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54057,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq54050){
var G__54051 = cljs.core.first(seq54050);
var seq54050__$1 = cljs.core.next(seq54050);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54051,seq54050__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54068_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__54068_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__54078_54181 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__54079_54182 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__54080_54183 = true;
var _STAR_print_fn_STAR__temp_val__54081_54184 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__54080_54183);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__54081_54184);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__54079_54182);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__54078_54181);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54070_SHARP_){
return debux.common.util.prepend_bars(p1__54070_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__54187 = cljs.core.next(opts__$1);
var G__54188 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__54187;
acc = G__54188;
continue;
} else {
if(typeof f === 'string'){
var G__54189 = cljs.core.next(opts__$1);
var G__54190 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__54189;
acc = G__54190;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__54191 = cljs.core.nnext(opts__$1);
var G__54192 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__54191;
acc = G__54192;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__54193 = cljs.core.next(opts__$1);
var G__54194 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__54193;
acc = G__54194;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__54102 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__54102.cljs$core$IFn$_invoke$arity$1 ? fexpr__54102.cljs$core$IFn$_invoke$arity$1(f) : fexpr__54102.call(null,f));
})())){
var G__54195 = cljs.core.next(opts__$1);
var G__54196 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__54195;
acc = G__54196;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__54103 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__54103.cljs$core$IFn$_invoke$arity$1 ? fexpr__54103.cljs$core$IFn$_invoke$arity$1(f) : fexpr__54103.call(null,f));
})())){
var G__54197 = cljs.core.nnext(opts__$1);
var G__54198 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__54197;
acc = G__54198;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__54199 = cljs.core.next(opts__$1);
var G__54200 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__54199;
acc = G__54200;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__54104){
...
var G__54109 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__54108 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__54108.cljs$core$IFn$_invoke$arity$1 ? fexpr__54108.cljs$core$IFn$_invoke$arity$1(G__54109) : fexpr__54108.call(null,G__54109));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__54111 = quoted_form;
var G__54112 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__54111,G__54112) : debux.common.util.remove_d.call(null,G__54111,G__54112));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__54113 = quoted_form;
var G__54114 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__54113,G__54114) : debux.common.util.remove_d.call(null,G__54113,G__54114));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__54213__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__54127 = quoted_form;
var G__54128 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__54127,G__54128) : debux.common.util.remove_d.call(null,G__54127,G__54128));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__54214__i < G__54214__a.length) {G__54214__a[G__54214__i] = arguments[G__54214__i + 0]; ++G__54214__i;}
  arg = new cljs.core.IndexedSeq(G__54214__a,0,null);
} 
return G__54213__delegate.call(this,arg);};
G__54213.cljs$lang$maxFixedArity = 0;
G__54213.cljs$lang$applyTo = (function (arglist__54215){
var arg = cljs.core.seq(arglist__54215);
return G__54213__delegate(arg);
});
...
var G__54218 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__54218;
continue;
} else {
...
var G__54219 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__54219;
continue;
} else {
var G__54220 = clojure.zip.next(loc);
loc = G__54220;
continue;
