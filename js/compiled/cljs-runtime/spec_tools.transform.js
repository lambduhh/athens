...
if((x instanceof cljs.core.Keyword)){
var G__55138 = spec;
var G__55139 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__55138,G__55139) : f.call(null,G__55138,G__55139));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__55140 = spec;
var G__55141 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__55140,G__55141) : f.call(null,G__55140,G__55141));
} else {
return x;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__55147,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55148__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__55150,x){
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__55153,x){
...
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55154__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
