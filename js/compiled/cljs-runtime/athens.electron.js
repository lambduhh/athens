...
var seq__52565 = cljs.core.seq(imgs);
var chunk__52566 = null;
var count__52567 = (0);
var i__52568 = (0);
while(true){
if((i__52568 < count__52567)){
var vec__52575 = chunk__52566.cljs$core$IIndexed$_nth$arity$2(null,i__52568);
var curr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52575,(0),null);
var new$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52575,(1),null);
athens.electron.fs.copyFileSync(curr,new$);


var G__52656 = seq__52565;
var G__52657 = chunk__52566;
var G__52658 = count__52567;
var G__52659 = (i__52568 + (1));
seq__52565 = G__52656;
chunk__52566 = G__52657;
count__52567 = G__52658;
i__52568 = G__52659;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__52565);
if(temp__5735__auto__){
var seq__52565__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__52565__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__52565__$1);
var G__52660 = cljs.core.chunk_rest(seq__52565__$1);
var G__52661 = c__4556__auto__;
var G__52662 = cljs.core.count(c__4556__auto__);
var G__52663 = (0);
seq__52565 = G__52660;
chunk__52566 = G__52661;
count__52567 = G__52662;
i__52568 = G__52663;
continue;
} else {
var vec__52578 = cljs.core.first(seq__52565__$1);
var curr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52578,(0),null);
var new$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52578,(1),null);
athens.electron.fs.copyFileSync(curr,new$);


var G__52664 = cljs.core.next(seq__52565__$1);
var G__52665 = null;
var G__52666 = (0);
var G__52667 = (0);
seq__52565 = G__52664;
chunk__52566 = G__52665;
count__52567 = G__52666;
i__52568 = G__52667;
continue;
}
} else {
...
var map__52592 = athens.db.get_block(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),target_uid], null));
...
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52592__$1,new cljs.core.Keyword("block","order","block/order",-1429282437));
...
})():(function (){var index = (function (){var G__52598 = drag_target;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52598__$1)].join('')));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fs","open-dialog","fs/open-dialog",-1381619732),(function (p__52602,_){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52603__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("local-storage","get-db-filepath","local-storage/get-db-filepath",-2015649354),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frame.core.inject_cofx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"local-storage","local-storage",-1301104068),"db/filepath")], null),(function (p__52607,_){
var map__52608 = p__52607;
var map__52608__$1 = (((((!((map__52608 == null))))?(((((map__52608.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52608.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__52608):map__52608);
var local_storage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52608__$1,new cljs.core.Keyword(null,"local-storage","local-storage",-1301104068));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("local-storage","navigate","local-storage/navigate",-707087458),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frame.core.inject_cofx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"local-storage","local-storage",-1301104068),"current-route/uid")], null),(function (p__52612,_){
...
var local_storage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52613__$1,new cljs.core.Keyword(null,"local-storage","local-storage",-1301104068));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fs","watch","fs/watch",380976938),(function (_,p__52624){
var vec__52625 = p__52624;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52625,(0),null);
var filepath = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52625,(1),null);
var dirpath_52670 = athens.electron.path.dirname(filepath);
athens.electron.fs.watch(dirpath_52670,(function (_event,filename){
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db","update-mtime","db/update-mtime",768440096),(function (db,p__52629){
var vec__52630 = p__52629;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52630,(0),null);
var mtime1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52630,(1),null);
var map__52633 = db;
var map__52633__$1 = (((((!((map__52633 == null))))?(((((map__52633.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52633.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__52633):map__52633);
var filepath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52633__$1,new cljs.core.Keyword("db","filepath","db/filepath",1097485287));
...
var schemas = (function (){var G__52640 = new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"find","find",496279456),new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Symbol(null,"?v","?v",-464183118,null),new cljs.core.Keyword(null,"where","where",-2044795965),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword("schema","version","schema/version",1396190655),new cljs.core.Symbol(null,"?v","?v",-464183118,null)], null)], null);
var G__52641 = cljs.core.deref(athens.db.dsdb);
return (datascript.core.q.cljs$core$IFn$_invoke$arity$2 ? datascript.core.q.cljs$core$IFn$_invoke$arity$2(G__52640,G__52641) : datascript.core.q.call(null,G__52640,G__52641));
})();
var schema_cnt = cljs.core.count(schemas);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((0),schema_cnt)){
var linked_ref_pattern_52671 = athens.patterns.linked(".*");
var blocks_with_plain_links_52672 = (function (){var G__52642 = new cljs.core.PersistentVector(null, 13, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"find","find",496279456),new cljs.core.Symbol(null,"?u","?u",749886731,null),new cljs.core.Symbol(null,"?s","?s",456183954,null),new cljs.core.Keyword(null,"keys","keys",1068423698),new cljs.core.Symbol("block","uid","block/uid",16946360,null),new cljs.core.Symbol("block","string","block/string",-426064920,null),new cljs.core.Keyword(null,"in","in",-1531184865),new cljs.core.Symbol(null,"$","$",-1580747756,null),new cljs.core.Symbol(null,"?pattern","?pattern",-694889304,null),new cljs.core.Keyword(null,"where","where",-2044795965),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Symbol(null,"?u","?u",749886731,null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword("block","string","block/string",-2066596447),new cljs.core.Symbol(null,"?s","?s",456183954,null)], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.list(new cljs.core.Symbol(null,"re-find","re-find",1143444147,null),new cljs.core.Symbol(null,"?pattern","?pattern",-694889304,null),new cljs.core.Symbol(null,"?s","?s",456183954,null))], null)], null);
var G__52643 = cljs.core.deref(athens.db.dsdb);
var G__52644 = linked_ref_pattern_52671;
return (datascript.core.q.cljs$core$IFn$_invoke$arity$3 ? datascript.core.q.cljs$core$IFn$_invoke$arity$3(G__52642,G__52643,G__52644) : datascript.core.q.call(null,G__52642,G__52643,G__52644));
})();
var blocks_orig_52673 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__52645){
...
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52646__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
var string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52646__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
...
}),blocks_with_plain_links_52672);
var blocks_temp_52674 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__52648){
...
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52649__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
...
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"transact","transact",-267998670),blocks_temp_52674], null));

re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"transact","transact",-267998670),blocks_orig_52673], null));
...
var schema_version_52675 = cljs.core.second(cljs.core.first(schemas));
var G__52651_52676 = schema_version_52675;
switch (G__52651_52676) {
case (1):
cljs.core.prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([["Schema version ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(schema_version_52675)].join('')], 0));

break;
default:
alert(Error(["No matching case clause for schema version: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(schema_version_52675)].join('')));
...
re_frame.core.reg_fx(new cljs.core.Keyword("fs","write!","fs/write!",-1029545496),(function (p__52652){
var vec__52653 = p__52652;
var filepath = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52653,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52653,(1),null);
