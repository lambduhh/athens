...
var vec__45018 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45018,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45018,(1),null);
...
var vec__45021 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45021,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45021,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__45024 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45024,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45024,(1),null);
...
var G__45085 = cljs.core.next(parses__$1);
parses__$1 = G__45085;
continue;
}
...
var G__45032 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__45033 = G__45032;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45033,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45033,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45033,(2),null);
var selection = vec__45033;
...
var vec__45039 = G__45032__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45039,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45039,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45039,(2),null);
var selection__$1 = vec__45039;
...
var G__45087 = cljs.core.long$(end__$1);
var G__45088 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__45089 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__45087;
parses__$1 = G__45088;
G__45032__$1 = G__45089;
continue;
...
var G__45047 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__45048 = G__45047;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45048,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45048,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45048,(2),null);
var selection = vec__45048;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__45047__$1 = G__45047;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__45054 = G__45047__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45054,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45054,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45054,(2),null);
var selection__$1 = vec__45054;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__45091 = cljs.core.long$(end__$1);
var G__45092 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__45093 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__45091;
parses__$1 = G__45092;
G__45047__$1 = G__45093;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__45062 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__45063 = G__45062;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45063,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45063,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45063,(2),null);
var selection = vec__45063;
var index__$2 = index__$1;
var parses__$1 = parses;
...
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__45069 = G__45062__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45069,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45069,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45069,(2),null);
var selection__$1 = vec__45069;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__45095 = cljs.core.long$(end__$1);
var G__45096 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__45097 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__45095;
parses__$1 = G__45096;
G__45062__$1 = G__45097;
continue;
...
if(cljs.core.truth_((function (){var fexpr__45074 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__45074.cljs$core$IFn$_invoke$arity$1 ? fexpr__45074.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__45074.call(null,output_format));
})())){
} else {
...
var G__45075 = output_format;
var G__45075__$1 = (((G__45075 instanceof cljs.core.Keyword))?G__45075.fqn:null);
switch (G__45075__$1) {
case "enlive":
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4115__auto__ = (function (){var G__45083 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__45082 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__45082.cljs$core$IFn$_invoke$arity$1 ? fexpr__45082.cljs$core$IFn$_invoke$arity$1(G__45083) : fexpr__45082.call(null,G__45083));
})();
