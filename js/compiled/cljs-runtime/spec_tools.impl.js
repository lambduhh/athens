...
var vec__55072 = cljs.core.rest(expr);
var seq__55073 = cljs.core.seq(vec__55072);
var first__55074 = cljs.core.first(seq__55073);
var seq__55073__$1 = cljs.core.next(seq__55073);
var vec__55075 = first__55074;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55075,(0),null);
var form = seq__55073__$1;
...
var G__55078 = x;
var G__55078__$1 = (((G__55078 == null))?null:spec_tools.impl.polish(G__55078));
var G__55078__$2 = (((G__55078__$1 == null))?null:cljs.core.name(G__55078__$1));
if((G__55078__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__55078__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__55079 = x;
var G__55079__$1 = (((G__55079 == null))?null:cljs.core.name(G__55079));
if((G__55079__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__55079__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__55080){
var map__55081 = p__55080;
...
var data = map__55081__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55081__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55081__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55081__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55081__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__55083){
...
var G__55086 = data;
var G__55086__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55086,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__55086);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55086__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__55086__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__55090 = form;
var G__55090__$1 = (((G__55090 == null))?null:cljs.core.rest(G__55090));
if((G__55090__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__55090__$1);
}
})();
var G__55091 = m;
var G__55091__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55091,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__55087_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__55087_SHARP_)));
})):G__55091);
var G__55091__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55091__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__55088_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__55088_SHARP_)));
})):G__55091__$1);
var G__55091__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55091__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__55089_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__55089_SHARP_));
})):G__55091__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__55091__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__55092 = (function (){var G__55093 = form;
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55092__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55092__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55092__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55092__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__55095 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__55095) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__55096 = form;
var G__55096__$1 = (((G__55096 == null))?null:cljs.core.seq(G__55096));
var G__55096__$2 = (((G__55096__$1 == null))?null:cljs.core.first(G__55096__$1));
if((G__55096__$2 == null)){
return null;
} else {
var fexpr__55097 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__55097.cljs$core$IFn$_invoke$arity$1 ? fexpr__55097.cljs$core$IFn$_invoke$arity$1(G__55096__$2) : fexpr__55097.call(null,G__55096__$2));
}
})():null));
});
/**
...
var len__4736__auto___55118 = arguments.length;
var i__4737__auto___55119 = (0);
while(true){
if((i__4737__auto___55119 < len__4736__auto___55118)){
args__4742__auto__.push((arguments[i__4737__auto___55119]));

var G__55120 = (i__4737__auto___55119 + (1));
i__4737__auto___55119 = G__55120;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq55098){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq55098));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__55099){
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__55105){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55106__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55106__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55106__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55106__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__55103_SHARP_){
return cljs.core.map_QMARK_(p1__55103_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__55104_SHARP_){
return cljs.core.contains_QMARK_(p1__55104_SHARP_,x);
});
}),req_keys));
