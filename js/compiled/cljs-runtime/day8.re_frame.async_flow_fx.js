 ...
 */
day8.re_frame.async_flow_fx.dissoc_in = (function day8$re_frame$async_flow_fx$dissoc_in(m,p__49577){
var vec__49578 = p__49577;
var seq__49579 = cljs.core.seq(vec__49578);
var first__49580 = cljs.core.first(seq__49579);
var seq__49579__$1 = cljs.core.next(seq__49579);
var k = first__49580;
var ks = seq__49579__$1;
var keys = vec__49578;
if(ks){
...
var G__49586 = new cljs.core.Keyword(null,"events","events",1792552201).cljs$core$IFn$_invoke$arity$1(task);
var G__49587 = now_seen_events;
var fexpr__49585 = new cljs.core.Keyword(null,"when","when",-576417306).cljs$core$IFn$_invoke$arity$1(task);
return (fexpr__49585.cljs$core$IFn$_invoke$arity$2 ? fexpr__49585.cljs$core$IFn$_invoke$arity$2(G__49586,G__49587) : fexpr__49585.call(null,G__49586,G__49587));
...
return cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (index,p__49590){
...
var rule = map__49591__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49591__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var when = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49591__$1,new cljs.core.Keyword(null,"when","when",-576417306));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49591__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49591__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49591__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49591__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var halt_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49591__$1,new cljs.core.Keyword(null,"halt?","halt?",-1110658247));
...
var G__49596 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4126__auto__ = id;
...
var G__49596__$1 = (cljs.core.truth_(dispatch_fn)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__49596,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614),dispatch_fn):G__49596);
if(cljs.core.not(dispatch_fn)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__49596__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),(cljs.core.truth_(dispatch_n)?dispatch_n:(cljs.core.truth_(dispatch)?(new cljs.core.List(null,dispatch,null,(1),null)):cljs.core.List.EMPTY
)));
} else {
return G__49596__$1;
}
...
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49602__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49602__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__49607){
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49608__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49608__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49608__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49608__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_handler(p__49616,p__49617){
var map__49618 = p__49616;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49618__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__49619 = p__49617;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49619,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49619,(1),null);
var event_v = vec__49619;
var pred__49624 = cljs.core._EQ_;
var expr__49625 = event_type;
if(cljs.core.truth_((pred__49624.cljs$core$IFn$_invoke$arity$2 ? pred__49624.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"setup","setup",1987730512),expr__49625) : pred__49624.call(null,new cljs.core.Keyword(null,"setup","setup",1987730512),expr__49625)))){
...
var vec__49627 = event_v;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49627,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49627,(1),null);
var map__49630 = get_state(db);
...
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49630__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49630__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
var vec__49637 = day8.re_frame.async_flow_fx.ensure_has_id(flow);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49637,(0),null);
var flow_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49637,(1),null);
