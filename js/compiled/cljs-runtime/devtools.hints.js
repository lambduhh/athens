...
}catch (e20740){var _e = e20740;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___20770 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20770)){
var seen_errors_20771 = temp__5733__auto___20770;
if(cljs.core.truth_(seen_errors_20771.has(self))){
} else {
seen_errors_20771.add(self);

var temp__5735__auto___20773 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20773)){
var sense_20774 = temp__5735__auto___20773;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20774)].join(''));
} else {
}
}
} else {
